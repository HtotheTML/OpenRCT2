...
#define DECRYPT_MONEY(money) (static_cast<money32>(Numerics::rol32((money) ^ 0xF4EC9621, 13)))
    ...
    public:
        ...
        void FixWater() const
        {
            ...
            {
                static constexpr const TileCoordsXY lakeCoordinates[] = {
                    { 103, 76 },
                    { 104, 76 },
                };
                for (TileCoordsXY tileCoordinates : lakeCoordinates)
                {
                    auto surfaceElement = MapGetSurfaceElementAt(tileCoordinates.ToCoordsXY());
                    surfaceElement->SetWaterHeight(112);
                }
            }
             else if (
                String::Equals(gScenarioFileName, "Build your own Six Flags Magic Mountain.SC6", true)
            ...
            {
                static constexpr const TileCoordsXY lakeCoordinates[] = {
                    { 66, 96 }, { 65, 96 }, { 65, 95 },  { 64, 95 }, { 63, 95 }, { 62, 95 }, { 61, 95 }, { 61, 96 }, { 60, 96 },
                    { 59, 96 }, { 58, 96 }, { 58, 97 },  { 57, 97 }, { 56, 97 }, { 56, 98 }, { 55, 98 }, { 55, 99 }, { 54, 99 },
                    { 53, 99 }, { 52, 99 }, { 52, 100 }, { 51, 99 }, { 50, 99 }, { 50, 98 }, { 49, 98 }, { 49, 97 }, { 48, 97 },
                    { 47, 97 }, { 47, 96 }, { 46, 96 },  { 46, 95 }, { 45, 95 }, { 45, 94 }, { 44, 94 }, { 43, 94 }, { 43, 93 },
                    { 42, 94 }, { 41, 94 }, { 41, 93 },  { 40, 93 }, { 40, 92 }, { 39, 92 }, { 39, 91 }, { 38, 91 }, { 37, 91 },
                    { 37, 90 }, { 36, 90 }, { 35, 90 },  { 35, 91 }, { 34, 91 }, { 33, 91 },
                };
                for (TileCoordsXY tileCoordinates : lakeCoordinates)
                {
                    auto surfaceElement = MapGetSurfaceElementAt(tileCoordinates.ToCoordsXY());
